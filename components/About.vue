<template>
  <div>
    <section class="mx-auto mt-2 p-6 bg-gray-100 rounded-lg">
      <h1 class="mb-4 text-2xl text-gray-800">About Me</h1>
      <p class="text-lg text-gray-600 leading-relaxed">
        ...
        <br />
        I have worked in the Digital Search Marketing industry for over 8 years, where I have honed my skills in software development and project management.
        ...
        technologies. My goal is to create solutions that make a positive impact
